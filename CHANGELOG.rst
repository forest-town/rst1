...
- The win32_event_log check
  has moved from Python (integrations-core#16108) 
...
- APM: Log throttling is now automatically enabled by default when
  ...
  messages every 10 seconds will be displayed. If you had it enabled before, it can now be removed from the config file.
